...
<head>
    ...
    <title>Внутренняя ошибка на сервере</title>
...
<body>
    <div class="cover">
        <h1>Внутренняя ошибка на сервере <small>Ошибка 500</small></h1>
        <p class="lead">Упс. Произошло что-то непредусмотренное!<br />
            Разработчики уже уведомлены. Попробуйте повторить это действие позже. </p>
